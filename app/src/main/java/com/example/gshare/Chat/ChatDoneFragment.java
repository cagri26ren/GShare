...
public class ChatDoneFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable final Bundle savedInstanceState) {
        ...
        returnedButton = view.findViewById(R.id.returnedButton);
        notReturnedButton = view.findViewById(R.id.notReturnedButton);
            ...
            public void onClick(View v) {
                handler.postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        DBHelper.updateUser(noticeOwner);
        ...
        notReturnedButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Bundle bundle = new Bundle();
                bundle.putString("email",email);
